...
We've done a lot of backend work so far. We've learned how to write endpoints, connect to databases (Firebase), and now understand how authentication works by hand! This week is our last week fully focused on backend topics. We'll be exploring service providers that make the authentication process MUCH easier and automatic! You will soon be able to see your websites on the web!

# Materials

[Day 13: Authentication on the Web](https://docs.google.com/presentation/d/17_Y6sNFOIiOyBrGVRtYckY0uTn_Z-PSV/edit?usp=sharing&ouid=105792284454467330830&rtpof=true&sd=true)

[Day 14: Advanced Authentication](https://docs.google.com/presentation/d/14WiLGKJ0HQ1Bn9B--y01Mf2iOmDQUFJr/edit?usp=sharing&ouid=105792284454467330830&rtpof=true&sd=true)
...
We coded up a pretty simple AuthContext.js file a while back. It did its job of creating dummy login and logout functions. It's time to fully flesh them out with actual user creation, login, and authentication using Firebase's functions.
...
- We will implement an authentication middleware using the Firebase Admin SDK.
